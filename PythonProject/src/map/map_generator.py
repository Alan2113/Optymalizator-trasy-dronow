...
class MapGenerator:
    ...
    def generate_rectangular_buildings(self, count):
        ...
        max_attempts = count * 10  # Maksymalna liczba prób
    ...
    def generate_forbidden_zones(self, count, existing_buildings):
        ...
        attempts = 0
        max_attempts = count * 10  # Zwiększona liczba prób
        min_distance_between_zones = 25  # Minimalna odległość między strefami
        ...
        while len(zones) < count and attempts < max_attempts:
            ...
            # Losowa pozycja i rozmiar strefy
            center_x = random.uniform(120, self.width - 120)
            center_y = random.uniform(120, self.height - 120)

            # Generuj nieregularny kształt strefy
            points = []
            num_points = random.randint(5, 8)
            base_radius = random.uniform(35, 70)  # Nieco mniejsze strefy
